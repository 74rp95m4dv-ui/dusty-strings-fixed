...
import {
  ...
  getHook, getLyric, computeAlbumWritingMix, type ReleaseType, type HookStyle, type LyricStyle,
} from "../gameLogic";
      ...
      <div className="card">
        ...
        {p.tracks.length < p.maxTracks && (
          <div style={{ marginTop: 10 }}>
            <input type="text" placeholder="Track name..." value={trackName} onChange={(e) => setTrackName(e.target.value)} style={{ marginBottom: 8 }} />
